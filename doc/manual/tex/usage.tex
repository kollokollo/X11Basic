...
Feodora}, {\normalfont \itshape Mandriva}, {\normalfont \itshape SuSE} and {\normalfont \itshape RedHat} (and maybe others,
...
based Linux distributions are {\normalfont \itshape Knoppix} and {\normalfont \itshape Ubuntu}\footnote{A list of
...
linux (specifically {\normalfont \itshape Ubuntu linux}). A
...
called \verb|X11-Basic-1.25-44.apk| usually  provided by {\normalfont \itshape Google Play}
(formerly known as {\normalfont \itshape Android Market}), which also installs it for you. If you
do not like to use {\normalfont \itshape Google Play} for some reason, you can also install
...
ARM-Linuxes like the one often used together with the {\normalfont \itshape Raspberry Pi}. 
...
\item[Edit] invokes {\normalfont \itshape notepad}, allowing you to edit your program.
...
is available on the {\normalfont \itshape Android Market} (also called {\normalfont \itshape Google Play}). 
...
\item[Editor] will execute a 3rd-party text editor (e.g. {\normalfont \itshape Ted} or 
{\normalfont \itshape Jota} or {\normalfont \itshape 920 Text Editor} if installed) to edit the program currently 
...
XXXXXXXXXXXXXXXXXXXX \=\kill\\
  {\normalfont \normalfont \bfseriesfamily \bf xbasic <filename> }  \> run Basic program \verb|[input.bas]|\\
  {\normalfont \normalfont \bfseriesfamily -l                 } \> load only, don't execute\\
  {\normalfont \normalfont \bfseriesfamily -e <command>       }\> execute basic command \\
  {\normalfont \normalfont \bfseriesfamily --eval <expression>}   \> evaluate numerical expression  \\
  {\normalfont \normalfont \bfseriesfamily --daemon           } \> switch off prompting and echoing\\
  {\normalfont \normalfont \bfseriesfamily -h --help          } \> print a short help \\
  {\normalfont \normalfont \bfseriesfamily --help <topic>     } \> print help on a specific topic\\
\end{tabbing}
...
The  command line option {\normalfont \normalfont \bfseriesfamily --daemon} forces the interpreter to run in
...
%user called {\normalfont \normalfont \bfseriesfamily xbasic} and insert
%{\footnotesize
% \begin{verbatim}
%       --- in /etc/inetd.conf: ---
...
{\normalfont \itshape notepad} text editor.
...
the {\normalfont \itshape Nirvana Editor} (\verb|nedit|, available for Linux, UNIX and WINDOWS) 
...
\subsection*{Using syntax highlighting with {\normalfont \normalfont \bfseriesfamily \bf nedit}}

NEdit, the full featured, plain text {\normalfont \itshape Nirvana 
...
\section{The X11-Basic compiler manager {\normalfont \normalfont \bfseriesfamily \bf xbc}}
