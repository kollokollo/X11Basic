...
\verb|X11Basic-1.27-1.i386.rpm|, then you can install this package (being
root) with 
\begin{verbatim}
rpm -i X11Basic-1.27-1.i386.rpm      .
\end{verbatim}
...
\verb|x11basic_1.27-1_i386.deb|. Usually you can very easily install the file
from a file browser with simply double clicking on it. Also a 
\begin{verbatim}
dpkg -i x11basic_1.27-1_i386.deb
\end{verbatim} 
...
installations, usually called \verb|x11basic_1.27-1_amd64.deb|. 
...
called \verb|X11-Basic-1.27-57.apk| usually  provided by {\it Google Play}
...
\verb|X11Basic-1.27.tar.gz| and compile the sources. This should work for  all
...
\item Unpack \verb|X11Basic-1.27.tar.gz| with 
\begin{verbatim}
tar xzf X11Basic-1.27.tar.gz
\end{verbatim}
\item go into the \verb|X11Basic-1.27| directory and do a 
\begin{verbatim}
./configure
make
sudo make install
...
\verb|X11-Basic-1.27-57-setup.exe|, which you can download from the homepage.
All files will be installed on the program folder on `C:`.

In the case you have got a .zip file, e.g. \verb|X11-Basic-1.27-1-win.zip|, 
...
\verb|X11-Basic-1.27-57.apk| which contains the app.  Download this file to 
