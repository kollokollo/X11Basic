CLS
PRINT
PRINT "Demo Program for the ATARI ST Version of X11-Basic."
PRINT "Be patient! The ATARI is slow!"
PRINT "The Number below will count forward to 100, then down to 0."
PRINT
sx=100
sy=sx*42/60
DIM x(sx+1,sy+1)
