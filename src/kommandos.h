...
void c_add(char *),c_quit(PARAMETER *,int),c_stop(char *),c_beep(char *);
...
void c_if(char *),c_sort(char *), c_fft(char *),c_fit(char *),c_fit_linear(char *);
...
void c_closew(char *),c_free(PARAMETER *,int),c_shm_free(PARAMETER *,int);
