...
PROCEDURE systemset
  LOCAL xU,yU,wU,hU,fdoretU,b$
  '
  ~@rsrc_gaddr(0,system__U,dialogadr%)
  ~FORM_CENTER(dialogadr%,xU,yU,wU,hU)
  '  ~FORM_DIAL(0,0,0,10,20,xU,yU,wU,hU)
  ~FORM_DIAL(1,0,0,10,20,xU,yU,wU,hU)
  @stext(dialogadr%,sysdt__U,STR$(dt,16))
  GET xU,yU,xU+wU,yU+hU,b$
  ~OBJC_DRAW(dialogadr%,0,8,xU,yU,wU,hU)
  fdoretU=FORM_DO(dialogadr%,0)
  dt=VAL(@ob_text$(dialogadr%,sysdt__U))
  PUT xU,yU,b$
  ' ~FORM_DIAL(3,0,0,10,20,xU,yU,wU,hU)
  ~FORM_DIAL(2,0,0,10,20,xU,yU,wU,hU)
  ~OBJC_CHANGE(dialogadr%,fdoretU,0,xU,yU,wU,hU,0,0)
...
PROCEDURE anfangsw
  LOCAL xU,yU,wU,hU,fdoretU,b$
  '
  ~@rsrc_gaddr(0,anfangsw__U,dialogadr%)
  ~FORM_CENTER(dialogadr%,xU,yU,wU,hU)
  '  ~FORM_DIAL(0,0,0,10,20,xU,yU,wU,hU)
  ~FORM_DIAL(1,0,0,10,20,xU,yU,wU,hU)
  @stext(dialogadr%,at0__U,STR$(t0,16))
  @stext(dialogadr%,ax__U,STR$(x0,16))
  @stext(dialogadr%,ay__U,STR$(y0,16))
  @stext(dialogadr%,axs__U,STR$(x_0,16))
  @stext(dialogadr%,ays__U,STR$(y_0,16))
  @stext(dialogadr%,axss__U,STR$(x__0,16))
  @stext(dialogadr%,ayss__U,STR$(y__0,16))
  GET xU,yU,xU+wU,yU+hU,b$
  ~OBJC_DRAW(dialogadr%,0,8,xU,yU,wU,hU)
  fdoretU=FORM_DO(dialogadr%,0)
  t0=VAL(@ob_text$(dialogadr%,at0__U))
  x0=VAL(@ob_text$(dialogadr%,ax__U))
  y0=VAL(@ob_text$(dialogadr%,ay__U))
  x_0=VAL(@ob_text$(dialogadr%,axs__U))
  y_0=VAL(@ob_text$(dialogadr%,ays__U))
  x__0=VAL(@ob_text$(dialogadr%,axss__U))
  y__0=VAL(@ob_text$(dialogadr%,ayss__U))
  PUT xU,yU,b$
  ' ~FORM_DIAL(3,0,0,10,20,xU,yU,wU,hU)
  ~FORM_DIAL(2,0,0,10,20,xU,yU,wU,hU)
  ~OBJC_CHANGE(dialogadr%,fdoretU,0,xU,yU,wU,hU,0,0)
